...
| Code | Activity | Notes |
|---|---|---|
| ACT-01 | [e.g., the contested grant/program] | |
| ACT-POL | The overall policy | Usually keep one code for the policy itself, distinct from individual activities |
...
## G. Timeline anchors
The 3–5 historical events that structure the study window.
